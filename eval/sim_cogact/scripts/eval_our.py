...
parser.add_argument("--log-dir-root", type=str, default="/ssd/home/wangfangjing/code/SimplerEnv-SOFAR/output/results_gemini-2.0-flash-exp-GD-threshold-0.1", help="log directory")
