...
from llavavla.training.strategies.base_strategy_cogact_qwen import TrainingStrategy

# Initialize Overwatch =>> Wraps `logging.Logger`
overwatch = initialize_overwatch(__name__)


class FSDPStrategy_QWen(TrainingStrategy):
    def __init__(
        self,
    ...
    def run_setup(self, run_dir: Path, n_train_examples: int) -> None:
        ...
        vlm_fsdp_wrapping_policy = self.vlm.get_fsdp_wrapping_policy() #@Jinhui TODO 我很不喜欢这种递归 调用风格！！！ 😧
