...
from llavavla.dataloader.gr00t_lerobot.datasets import ModalityConfig
from llavavla.dataloader.gr00t_lerobot.transform.base import ComposedModalityTransform, ModalityTransform
from llavavla.dataloader.gr00t_lerobot.transform.concat import ConcatTransform
from llavavla.dataloader.gr00t_lerobot.transform.state_action import (
    StateActionSinCosTransform,
    StateActionToTensor,
    StateActionTransform,
)
from llavavla.dataloader.gr00t_lerobot.transform.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
...
class SinglePandaHandDataConfig:
    video_keys = [
        "video.first_view",
        "video.wrist_view",
    ]
...
class SingleFrankaRobotiqDataConfig:
    ...
    state_keys = [
        ...
        "observation.states.gripper.position",
        "observation.states.ee.position",
        "observation.states.ee.orientation",
    ]
    action_keys = [
        "actions.joint.position",
        "actions.joint.velocity",
        "actions.gripper.position",
        "actions.gripper.velocity",
        "actions.ee.position",
        "actions.ee.orientation",
    ]
...
DATA_CONFIG_MAP = {
    ...
    "bridge_orig_1.0.0_lerobot": OxeBridgeDataConfig(),
    "fractal20220817_data_0.1.0_lerobot": OxeRT1DataConfig(),
    "bench_v6_all_longrange_split0_h264": SinglePandaHandDataConfig(),
    "bench_v6_all_longrange_split1_h264": SinglePandaHandDataConfig(),
